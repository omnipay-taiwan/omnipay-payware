...
**Note:** Replace `omnipay-taiwan`, `:author_name`, `recca0120`, `:author_website`, `:author_email`, `payware`
, `:package_description` and `payware` with their correct values in [README.md](README.md)
